...
import com.example.velo_app.databinding.ActivityVeloMaps2Binding
...
class VeloMapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private lateinit var binding: ActivityVeloMaps2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityVeloMaps2Binding.inflate(layoutInflater)
